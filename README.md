...
Live Demo: https://robot-finesyt.vercel.app
...
- **GitHub Pages (static export)** — If exporting, set `output: 'export'` in `next.config.ts` and publish `out/`; live at https://robot-finesyt.vercel.app
